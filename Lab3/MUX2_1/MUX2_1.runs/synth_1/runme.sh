...
HD_PWD='C:/Users/Chuong/Documents/Verilog/MUX2_1/MUX2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX2_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MUX2_1.tcl
